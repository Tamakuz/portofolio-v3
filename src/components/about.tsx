                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="lg:sticky lg:top-32">
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                            className="text-6xl md:text-8xl font-black italic mb-8 leading-none"
                        >
                        ...
                        <motion.div
                            ...
                            className="space-y-6 text-xl text-muted-foreground leading-relaxed max-w-xl"
                        >
                            <p>
                                I'm Jovan, a digital architect obsessed with the intersection of logic and aesthetics.
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {stats.map((stat, index) => (
                            <motion.div
                                ...
                                className="p-8 rounded-[2.5rem] bg-card border border-border group transition-all duration-500"
                            >
                        ...
                        <motion.div
                            ...
                            className="md:col-span-2 p-10 rounded-[2.5rem] bg-primary text-black"
                        >
